...
class TestSetup(BaseTestClass):
    def setup(self):
        ...
        self.login_args = ["-u {}".format(self.username), "-p {}".format(self.password)]
        self.login_args_with_new_host = self.login_args.append("-h {}".format(self.new_host))
        self.login_args_with_current_host = self.login_args.append("-h {}".format(self.current_host))

...
class URLS(Enum):
    ...
    complete_upload_for_submission_file = "/api/jobs/phases/{}/submission_file_upload_complete/{}/"
    complete_upload_for_annotation_file = "/api/challenges/phases/{}/annotation_file_upload_complete/"
